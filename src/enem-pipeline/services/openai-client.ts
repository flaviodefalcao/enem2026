        ...
        : [
            {
              ...
              text:
                attempt === 2
                  ? "Sua resposta anterior saiu com JSON inválido. Refaça e retorne JSON estrito, válido e completo, sem markdown e sem texto fora do objeto."
                  : "Sua resposta anterior saiu inválida de novo. Refaça de forma mais concisa: strings curtas, listas objetivas, sem repetição, retornando apenas JSON válido e completo.",
            },
            ...baseContent,
          ];
              ...
              text:
                attempt === 1
                  ...
                  : attempt === 2
                    ...
                    : `${prompt.system} JSON inválido é proibido. Seja mais conciso para caber inteiro e retorne apenas JSON válido.`,
            },
          ],
        },
        {
